...
//For determin the MPU6050 address see ''Datasheet MPU-6050 Product Specification'' section 9.2 I2C Interface.
#define MPU6050_ADDR 	 	 0x68	//when ADO = 0 is: #define MPU6050_ADDR  0x68  //when ADO = 1 is: #define MPU6050_ADDR  0x69
